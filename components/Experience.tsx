...
const TimelineItem: React.FC<{ item: TimelineEvent; icon: React.ReactNode; isLast?: boolean }> = ({ item, icon, isLast = false }) => (
  ...
  >
    ...
    <div>
      ...
      <h4 className="text-sm font-semibold text-gray-600 mb-2">{item.subtitle}</h4>
...
export const Experience: React.FC = () => {
  return (
    ...
    >
      <motion.h2 variants={itemVariants} className="text-3xl md:text-4xl font-bold text-gray-900 mb-12">
        My Journey
      </motion.h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 max-w-5xl">
        <motion.div variants={containerVariants}>
          <h3 className="text-xl font-semibold text-gray-800 mb-8 relative">
            Work Experience
          </h3>
